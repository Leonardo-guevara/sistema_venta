      ...
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            ...
            <br>
              <p>
                <a href="<?=base_url()?>persona/insert" class="btn btn-app">
                  <span class="badge bg-success">Nuevo</span>
                  <i class="fas fa-users"></i> Persona
                </a>
                <a href="<?=base_url()?>persona/recovery" class="btn btn-app bg-danger" > 
      ...
      <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tr>
                    ...
                    <td><?= esc($news_item['telefono']); ?></td>
                    <td><?= esc($news_item['cedula']); ?></td>
                    <td>
                      <div class="btn-group btn-group-sm"> 
                        <a href="<?=base_url()?>persona/update?id=<?= esc($news_item['idpersona']); ?>"><button type="button" class="btn btn-warning"> <i class="fas fa-edit"></i> Editar</button></a>
                        <button type="button" onclick="mydelete('<?= esc($news_item['idpersona']); ?>','<?= esc($news_item['nombre']); ?>')" class="btn btn-danger"><i class="fas fa-trash-alt"></i> Eliminar</button>
                      </div>
                    </td>
                  </tr>
                  <?php  endforeach; ?>
  ...
  $(function () {
    ...
    swalWithBootstrapButtons.fire({
      ...
      if (result.isConfirmed) {
        location.href='<?=base_url()?>persona/delete?id='+id
        // swalWithBootstrapButtons.fire(
        //   'Eliminado!',
