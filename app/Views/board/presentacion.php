                  ...
                  <tr>
                    ...
                    <td>
                      <div class="btn-group btn-group-sm">
                        <a href="<?=base_url()?>presentacion/update?id=<?= esc($news_item['idpresentacion']); ?>"><button type="button" class="btn btn-warning"> <i class="fas fa-edit"></i> Editar</button></a>
                        <button type="button" onclick="mydelete('<?= esc($news_item['idpresentacion']); ?>','<?= esc($news_item['name']); ?>')" class="btn btn-danger"><i class="fas fa-trash-alt"></i> Eliminar</button>
                      </div>
  ...
  $(function () {
    ...
    swalWithBootstrapButtons.fire({
      ...
      if (result.isConfirmed) {
        location.href='<?=base_url()?>presentacion/delete?id='+id
        // swalWithBootstrapButtons.fire(
        //   'Eliminado!',
