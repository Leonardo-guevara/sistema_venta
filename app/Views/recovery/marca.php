                  ...
                  <tr>
                    ...
                    <td>
                      <div class="btn-group btn-group-sm"> 
                        <button type="button" onclick="mydelete('<?= esc($news_item['idmarca']); ?>','<?= esc($news_item['name']); ?>')" class="btn btn-app"><i class="fas fa-trash-alt"></i> Recuperar</button>
                      </div>
                    </td>
                  </tr>
                  <?php  endforeach; ?>
  ...
  $(function () {
    ...
    swalWithBootstrapButtons.fire({
      ...
      if (result.isConfirmed) {
        location.href='<?=base_url()?>marca/recovery_mode?id='+id
        // swalWithBootstrapButtons.fire(
        //   'Eliminado!',
