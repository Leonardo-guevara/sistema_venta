                    ...
                    <div class="col-md-12">
                      ...
                      ?>
                                                <input type="text" name="codigo" class="form-control"
                                                    placeholder="Ingrese codigo" value="<?=$codigo;?>">
                                            </div>
                                            <div class="form-group">
                                                <label>Detalle</label>
                                                <?php 
                      ...
                      ?>
                        ...
                        ?>
                                                ...
                                                <input type="file" accept="image/*" name="file" class="form-control"
                                                    value="<?=$file;?>" onchange="loadFile(event)">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                      ...
                      ?>
                                                <input type="text" name="name" class="form-control"
                                                    placeholder="Ingrese Nombre" value="<?=$name; ?>">
                                            </div>
                                            <div class="form-group">
                                                <label>Unidad</label>
                      ...
                      ?>
                                                <select id="unidad" onchange="select_presentacion()"
                                                    class="form-control select2" name="fk_unidad">
                                                    <?php
                      ...
                      ?>
                                                <select class="form-control select2" name="fk_marca"
                                                    style="width: 100%;">
                                                    <?php
                                            ...
                                            <div class="form-group">
                                                ...
                                                ?>
                                                <select class="form-control select2" id="presentacion"
                                                    name="fk_presentacion" style="width: 100%;">
                                                    <?php
                      ...
                      ?>
                                                <select class="form-control select2" name="fk_categoria"
                                                    value="<?=$fk_categoria; ?>" style="width: 100%;">
                                                    <?php
                      ...
                      ?>
                                                <input type="number" name="stocks" class="form-control"
                                                    placeholder="Cantidad de stocks" value="<?=$stocks; ?>">
                                            </div>
                                            <div class="form-group">
                      ...
                      ?>
                                                <input type="number" name="minimo" class="form-control"
                                                    placeholder="Cantidad de minimo" value="<?=$minimo; ?>">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                      ...
                      ?>
                                                <input type="number" id="mySelect" name="precio_compra"
                                                    class="form-control" placeholder="Precio de compra"
                                                    value="<?=$precio_compra; ?>" step="0.01">
                                            </div>
                                            <div class="form-group">
                      ...
                      ?>
                                                <input type="number" step="0.01" id="cobertura" name="precio_venta"
                                                    class="form-control" placeholder="valor" value="<?=$precio_venta;?>"
                                                    onkeydown="cien()" />
