      ...
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            ...
            <br>
              <p>
                <a href="<?=base_url()?>usuario/insert" class="btn btn-app bg-success">
                  <span class="badge bg-success">Nuevo</span>
                  <i class="fas fa-users"></i> Usuario
                </a>
                <a href="<?=base_url()?>usuario/recovery" class="btn btn-app bg-danger" > 
      ...
      <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tr>
                    ...
                    <td>
                    <?= esc($news_item['fkroles']); ?>
                    <td>
                      <div class="btn-group btn-group-sm">
                        <a href="<?=base_url()?>usuario/update?id=<?= esc($news_item['idusuario']); ?>"><button type="button" class="btn btn-warning"> <i class="fas fa-edit"></i> Editar</button></a>
                        <button type="button" onclick="mydelete('<?= esc($news_item['idusuario']); ?>','<?= esc($news_item['usuario']); ?>')" class="btn btn-danger"><i class="fas fa-trash-alt"></i> Eliminar</button>
                      </div>
                    </td>
                  </tr>
                  <?php  endforeach; ?>
  ...
  $(function () {
    ...
    swalWithBootstrapButtons.fire({
      ...
      if (id == 1 ) {
        ...
        location.href='<?=base_url()?>usuario/delete?id='+id
        // swalWithBootstrapButtons.fire(
        //   'Eliminado!',
