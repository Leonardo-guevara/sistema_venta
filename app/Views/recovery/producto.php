                  ...
                  <tr>
                    ...
                    <td>
                      <div class="btn-group btn-group-sm"> 
                        <button type="button" onclick="mydelete('<?= esc($news_item['idproducto']); ?>','<?= esc($news_item['name']); ?>')" class="btn btn-danger"><i class="fas fa-trash-alt"></i> Recuperar</button>
                      </div>
  ...
  $(function () {
    ...
    swalWithBootstrapButtons.fire({
      ...
      if (result.isConfirmed) {
        location.href='<?=base_url()?>producto/recovery_mode?id='+id
        // swalWithBootstrapButtons.fire(
        //   'Eliminado!',
