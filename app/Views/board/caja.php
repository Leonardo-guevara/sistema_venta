      ...
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            ...
            <br>
              <a href="<?=base_url()?>caja/insert" class="btn btn-app bg-success">
                  <span class="badge bg-success">Nuevo</span>
                  <i class="fas fa-inbox"></i>Caja
                </a>
                <a href="<?=base_url()?>caja/recovery" class="btn btn-app bg-danger" > 
    ...
    <!-- Main content -->
      ...
      <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tr>
                    <td><?= esc($news_item['idcaja']); ?></td>
                    <td><?= esc($news_item['name']); ?></td>

                    <td>
                        <a href="<?=base_url()?>caja/arqueo?id=<?= esc($news_item['idcaja']); ?>" >
                            <i class="fa fa-th-list" aria-hidden="true"></i> Historial
                        </a>
                    <td>
                      <div class="btn-group btn-group-sm">
                        <a href="<?=base_url()?>caja/update?id=<?= esc($news_item['idcaja']); ?>" class="btn btn-info"><i class="fas fa-edit"></i></a>
                        <a onclick="mydelete('<?= esc($news_item['idcaja']); ?>','<?= esc($news_item['name']); ?>')" class="btn btn-danger"><i class="fas fa-trash"></i></a>
                      </div>    
                    </td>
                  </tr>
                  <?php  endforeach; ?>
  ...
  $(function () {
    ...
    swalWithBootstrapButtons.fire({
      ...
      if (result.isConfirmed) {
        location.href='<?=base_url()?>caja/delete?id='+id
        // swalWithBootstrapButtons.fire(
        //   'Eliminado!',
