        ...
        <div class="card-body">
            <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
                    ...
                    <tr>
                        <td>
                            <?= esc($news_item['idpresentacion']); ?>
                        </td>
                        <td>
                            <?= esc($news_item['name']); ?>
                        </td>
                        <td>
                            <?= esc($news_item['unidad']); ?>
                        </td>
                        <td>
                            <div class="btn-group btn-group-sm">
                                <button type="button"
                                    onclick="mydelete('<?= esc($news_item['idpresentacion']); ?>','<?= esc($news_item['name']); ?>','../presentacion/recovery_mode')"
                                    class="btn btn-app"><i class="fas fa-trash-alt"></i> Recuperar</button>
                            </div>
...
<script src="<?= base_url(); ?>public\js\recuperar.js"></script>