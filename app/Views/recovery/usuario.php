      ...
      <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tr>
                    ...
                    <td>
                      <img src="<?=esc(base_url().$news_item['foto']); ?>" class="img-fluid img-thumbnail" width="100" height="100"  alt="<?= esc($news_item['usuario']); ?>" >
                    </td>
                    <td>
                    <?= esc($news_item['fkroles']); ?>
                    <td>
                      <div class="btn-group btn-group-sm">
                        <button type="button" onclick="mydelete('<?= esc($news_item['idusuario']); ?>','<?= esc($news_item['usuario']); ?>')" class="btn btn-app"><i class="fas fa-trash-alt"></i> recuperar</button>
                      </div>
  ...
  $(function () {
    ...
    swalWithBootstrapButtons.fire({
      ...
      if (id == 1 ) {
        ...
        location.href='<?=base_url()?>usuario/recovery_mode?id='+id
        // swalWithBootstrapButtons.fire(
        //   'Eliminado!',
