                  ...
                  <tr>
                    ...
                    <td>  
                      <div class="btn-group btn-group-sm">
                        <button type="button" onclick="mydelete('<?= esc($news_item['idcaja']); ?>','<?= esc($news_item['name']); ?>')" class="btn btn-app"><i class="fas fa-trash-alt"></i> recuperar</button>
                      </div>
                    </td>
                  </tr>
                  <?php  endforeach; ?>
...
<script>
  $(function () {
    ...
    swalWithBootstrapButtons.fire({
      ...
      confirmButtonText: '¡Sí, Recupera!',
      cancelButtonText: 'No, cancelar!',
      reverseButtons: true
    }).then((result) => {
      if (result.isConfirmed) {
        location.href='<?=base_url()?>caja/recovery_mode?id='+id
        // swalWithBootstrapButtons.fire(
        //   'Eliminado!',
