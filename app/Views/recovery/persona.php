                  ...
                  <tr>
                    ...
                    <td>
                      <div class="btn-group btn-group-sm"> 
                        <button type="button" onclick="mydelete('<?= esc($news_item['idpersona']); ?>','<?= esc($news_item['nombre']); ?>')" class="btn btn-app"><i class="fas fa-trash-alt"></i> Recuperar</button>
                      </div>
                    </td>
                  </tr>
                  <?php  endforeach; ?>
  ...
  $(function () {
    ...
    swalWithBootstrapButtons.fire({
      ...
      if (result.isConfirmed) {
        location.href='<?=base_url()?>persona/recovery_mode?id='+id
        // swalWithBootstrapButtons.fire(
        //   'Eliminado!',
